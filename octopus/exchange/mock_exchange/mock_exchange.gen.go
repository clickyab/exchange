...
// Source: clickyab.com/exchange/octopus/exchange (interfaces: Impression,Demand,Publisher,Location,Supplier,BidResponse,Bid,AdDetail,BidRequest,Banner,Device,Inventory,Site,App,Native,Renderer,User,Video)
