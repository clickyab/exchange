...
mockentity: $(LINTER) mockgen
	...
	$(BIN)/mockgen -destination=$(ROOT)/octopus/exchange/mock_exchange/mock_exchange.gen.go clickyab.com/exchange/octopus/exchange Impression,Demand,Publisher,Location,Supplier,BidResponse,Bid,AdDetail,BidRequest,Banner,Device,Inventory,Site,App,Native,User,Video
